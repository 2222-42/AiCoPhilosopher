...
- **FR-027**: System MUST support scrolling through command history (readline-style) within the REPL session: up/down arrow keys to navigate previous inputs, Ctrl+R for reverse search through history. Command history is persisted as part of the session state.
